	...
	DIALOG = [
		{
			...
			"speaker": "Narator",
			"teks":    "Kamu terbangun mendapati dirimu menyaksikan pemandangan itu",
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_1.png",
		...
		{   
			...
			"pilihan": true,
			"btn1":    "....",
			"btn2":    "A-aku sendiri tidak tahu...",
		},
		{
			"image":   "res://Asset/Ending/True/S935_2.png",
			"speaker": "Anak",
			"teks":    "%s, apakah kamu masih terjebak di masa lalu itu?" % gender,
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_2.png",
			"speaker": "Anak",
			"teks":    "Kumohon, jangan terpaku pada masa lalu",
			"pilihan": true,
			"btn1":    "....",
			"btn2":    "....",
		},
		{
			"image":   "res://Asset/Ending/True/S935_2.png",
			"speaker": "Anak",
			"teks":    "Aku sudah tiada, namun bukan berarti kamu harus terjebak di masa lalu",
			"pilihan": true,
			"btn1":    "....",
			"btn2":    "....",
		},
		{
			...
			"speaker": "Narator",
			"teks":    "kamu mulai mengingat, bahwa korban kecelakaan hari itu ada 2 orang",
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_3.png",
			"speaker": "Araya",
			"teks":    "Jadi.... kumohon, bangkitlah dari mimpi ini",
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_3.png",
			"speaker": "Araya",
			"teks":    "Meskipun aku telah tiada, bukan berarti hubungan kita akan menghilang",
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_3.png",
			"speaker": "Araya",
			"teks":    "Ingat apa yang kau katakan %s? S bukan untuk Sayonara" % gender,
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_3.png",
			"speaker": "Araya",
			"teks":    "Jadi kumohon %s kembalilah ke kenyataan" % gender,
			"pilihan": true,
			"btn1":    "....",
			"btn2":    "....",
		},
		{
			"image":   "res://Asset/Ending/True/S935_3.png",
			"speaker": "Narator",
			"teks":    "Kamu menutup mata, untuk mengucapkan selamat tinggal terakhir padanya",
			"pilihan": false
		},
		{
			"image":   "res://Asset/Ending/True/S935_3.png",
			"speaker": "Narator",
			"teks":    "Karna mungkin, suatu hari kalian bisa bertemu kembali",
			"pilihan": false
		},
	]
